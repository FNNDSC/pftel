...
#             )
# pudb.set_trace()
# d_telemetry:dict     = SMDB.service_keyAccess('telemetry')
# if d_telemetry['status']:
#     for service in list(d_telemetry['telemetry']['pftel'].keys()):
#         d_info      = d_telemetry['telemetry']['pftel'][service]['info']
...
tags_metadata: list = [
    {
        ...
        "description"   :
            """
            Provide API POST endpoints that will log payloads of various
